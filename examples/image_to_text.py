...
Prerequisites:
    ...
    Ready to run as-is: sample captcha images are bundled in assets/.
...
# --- Basic example ---
# Solves a simple 5-digit image captcha (assets/captcha-digits.png)
...
# instruction image (assets/captcha-math-instructions.png).
try:
